...
- **도커 기반의 CI/CD 자동화 및 AWS서버 환경** 구축으로 안정적인 서비스 제공
...
- 도메인별 MVC 디자인 패턴을 활용 ➡️ 유지보수 효율성 향상
- REST API를 활용 ➡️ 실시간 정보 전달을 통한 데이터 변동 사항 즉각 확인
- CSRF, 세션 인증, 경로 접근 제한 등 기능 사용 ➡️ 사용자별 데이터 및 서버 접근 보안 강화
- Genkins와 GitHub, 도커, 우분투(리눅스)를 활용한 CD/CD 기능 구현 ➡️ 개발자 유지보수 효율성 증가
- AWS를 활용 ➡️ 실시간 및 안전성을 갖춘 서버 배포
